...
namespace tsdn.Common.Dapper
{
    ...
    public interface IDapperRepository<TEntity> where TEntity : class
    {
        ...
        ///     Bulk Insert objects to DB
        /// </summary>
        int AddRange(IEnumerable<TEntity> instances, IDbTransaction transaction = null);
        ...
        /// </summary>
        int RemoveRange(IEnumerable<TEntity> instances, IDbTransaction transaction = null);
